...
<div><span class="controls" ng-click="openAdd()" tooltip-placement="left" tooltip="Add" ><span class="controls-small">&#xf067;</span>&#xf02d;</span></div>
...
<script type="text/ng-template" id="ModalEdit.html">
  ...
  <div class="form-group">
	...
	<div class="col-xs-6">
      <input type="text" class="form-control" id="title" placeholder="Title" ng-model="current_course.title">
    </div>
  </div>
...
<div class="form-group">
	...
	<div class="col-xs-6">
      <input type="number" class=" validate-numeric form-control" id="unit" placeholder="Unit" ng-model="current_course.units">
    </div>
  </div>
...
<select class="form-control" ng-model="current_course.status">
 ...
 <option value="0">Inactive</option>
        ...
        <div class="modal-footer">
<div class="col-sm-8 down" ng-hide="course_progress_hidden"><progressbar class="progress-striped active down" max="200" value="200" type="primary"></progressbar></div>
...
<script type="text/ng-template" id="ModalDel.html">
        ...
        <div class="modal-footer">
		<div class="col-sm-8 down"><progressbar class="progress-striped active down" max="200" value="200" type="danger"></progressbar></div>

            <button class="btn btn-danger" ng-click="addStud()">Delete</button>
            <button class="btn btn-warning" ng-click="cancel()">Cancel</button>
        </div>
    </script>
